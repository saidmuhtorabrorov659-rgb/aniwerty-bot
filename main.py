...
# To'liq anime bazasi (barcha file_id lari bilan)
ANIME_DATABASE = {
    "1": {
        "title": "Zombi 100",
        "total": 12,
...
# Asosiy menyu (animelar ro'yxati)
def get_main_keyboard():
    buttons = []
    for code, data in ANIME_DATABASE.items():
        buttons.append([InlineKeyboardButton(text=data["title"], callback_data=f"anime_{code}")])
